...
public class UnConverter{
	UnConverter()throws IOException{	}
	
	public static String Activate(String toUnconvert) throws IOException{	
		String A = "A";
		String B = "B";
		String C = "C";
		String D = "D";
		...
		String finalDigits = toUnconvert.substring(originalToUnconvertLength - 2,originalToUnconvertLength);
		toUnconvert = toUnconvert.substring(0, originalToUnconvertLength - 2);
		int toUnconvertLength = toUnconvert.length();
		
		String unconverted = "";
		
		if(finalDigits.equals("11")){
			for(int placeValue = 0;placeValue < toUnconvertLength;placeValue++){
				String digits = toUnconvert.substring(placeValue, placeValue + 3);
				BigInteger digitsNumberForm = new BigInteger(digits);
				if(digitsNumberForm.equals(CapANum)){
					unconverted = unconverted  + A;
				}
				if(digitsNumberForm.equals(CapBNum)){
					unconverted = unconverted  + B;
				}
				if(digitsNumberForm.equals(CapCNum)){
					unconverted = unconverted  + C;
				}
				if(digitsNumberForm.equals(CapDNum)){
					unconverted = unconverted  + D;
				}
				if(digitsNumberForm.equals(CapENum)){
					unconverted = unconverted  + E;
				}
				if(digitsNumberForm.equals(CapFNum)){
					unconverted = unconverted  + F;
				}
				if(digitsNumberForm.equals(CapGNum)){
					unconverted = unconverted  + G;
				}
				if(digitsNumberForm.equals(CapHNum)){
					unconverted = unconverted  + H;
				}
				if(digitsNumberForm.equals(CapINum)){
					unconverted = unconverted  + I;
				}
				if(digitsNumberForm.equals(CapJNum)){
					unconverted = unconverted  + J;
				}
				if(digitsNumberForm.equals(CapKNum)){
					unconverted = unconverted  + K;
				}
				if(digitsNumberForm.equals(CapLNum)){
					unconverted = unconverted  + L;
				}
				if(digitsNumberForm.equals(CapMNum)){
					unconverted = unconverted  + M;
				}
				if(digitsNumberForm.equals(CapNNum)){
					unconverted = unconverted  + N;
				}
				if(digitsNumberForm.equals(CapONum)){
					unconverted = unconverted  + O;
				}
				if(digitsNumberForm.equals(CapPNum)){
					unconverted = unconverted  + P;
				}
				if(digitsNumberForm.equals(CapQNum)){
					unconverted = unconverted  + Q;
				}
				if(digitsNumberForm.equals(CapRNum)){
					unconverted = unconverted  + R;
				}
				if(digitsNumberForm.equals(CapSNum)){
					unconverted = unconverted  + S;
				}
				if(digitsNumberForm.equals(CapTNum)){
					unconverted = unconverted  + T;
				}
				if(digitsNumberForm.equals(CapUNum)){
					unconverted = unconverted  + U;
				}
				if(digitsNumberForm.equals(CapVNum)){
					unconverted = unconverted  + V;
				}
				if(digitsNumberForm.equals(CapWNum)){
					unconverted = unconverted  + W;
				}
				if(digitsNumberForm.equals(CapXNum)){
					unconverted = unconverted  + X;
				}
				if(digitsNumberForm.equals(CapYNum)){
					unconverted = unconverted  + Y;
				}
				if(digitsNumberForm.equals(CapZNum)){
					unconverted = unconverted  + Z;
				}
